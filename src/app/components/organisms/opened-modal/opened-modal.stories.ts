...
// Import Menu Item
import { OpenedModalComponent } from './opened-modal.component';

// Define component
export default {
    title: 'Organisms/OpenedModal',
    component: OpenedModalComponent,
    decorators: [
        moduleMetadata({
...
// Define template
// OpenedModalComponent
const OpenedModalTemplate: Story<OpenedModalComponent> = (args: OpenedModalComponent) => ({
    props: { ...args },
    template: `<nwn-opened-modal></nwn-opened-modal>`,
});

export const OpenedModal = OpenedModalTemplate.bind({});
OpenedModal.storyName = 'Opened Modal';
OpenedModal.args = {};
