...
// Import Menu Item
import { FilterBrandsFormatsComponent } from './filter-brands-formats.component';

// Define component
export default {
    title: 'Organisms/FilterBrandsFormats',
    component: FilterBrandsFormatsComponent,
...
// Define template
const FilterBrandsFormatsTemplate: Story<FilterBrandsFormatsComponent> = (args: FilterBrandsFormatsComponent) => ({
    props: { ...args },
    template: `<nwn-filter-brands-formats></nwn-filter-brands-formats>`,
});

export const FilterBrandsFormats = FilterBrandsFormatsTemplate.bind({});
FilterBrandsFormats.storyName = 'Filter brands formats';
FilterBrandsFormats.args = {};
