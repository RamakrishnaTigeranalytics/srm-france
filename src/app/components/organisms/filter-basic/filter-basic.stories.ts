...
export default {
    ...
    component: FilterBasicComponent,
...
// Define template
const FilterBasicTemplate: Story<FilterBasicComponent> = (args: FilterBasicComponent) => ({
    props: { ...args },
    template: `<nwn-filter-basic></nwn-filter-basic>`,
});
