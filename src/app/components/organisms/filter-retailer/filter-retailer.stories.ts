...
// Import Menu Item
import { FilterRetailerComponent } from './filter-retailer.component';

// Define component
export default {
    title: 'Organisms/FilterRetailer',
    component: FilterRetailerComponent,
...
// Define template
const FilterRetailerTemplate: Story<FilterRetailerComponent> = (args: FilterRetailerComponent) => ({
    props: { ...args },
    template: `<nwn-filter-retailer></nwn-filter-retailer>`,
});

export const FilterRetailer = FilterRetailerTemplate.bind({});
FilterRetailer.storyName = 'Filter retailer';
FilterRetailer.args = {};
