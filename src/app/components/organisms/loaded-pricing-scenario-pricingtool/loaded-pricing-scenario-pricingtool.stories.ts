...
// Import Menu Item
import { LoadedPricingScenarioPricingtoolComponent } from './loaded-pricing-scenario-pricingtool.component';

// Define component
export default {
    title: 'Organisms/LoadedPricingScenarioPricingtoolComponent',
    component: LoadedPricingScenarioPricingtoolComponent,
...
// Define template
// LoadScenarioPricing
const LoadedPricingScenarioPricingtoolComponentTemplate: Story<LoadedPricingScenarioPricingtoolComponent> = (
    args: LoadedPricingScenarioPricingtoolComponent,
) => ({
    props: { ...args },
    template: `<nwn-loaded-pricing-scenario-pricingtool></nwn-loaded-pricing-scenario-pricingtool>`,
});

export const LoadedPricingScenarioPricingtool = LoadedPricingScenarioPricingtoolComponentTemplate.bind({});
LoadedPricingScenarioPricingtool.storyName = 'Loaded Pricing Scenario Pricingtool';
LoadedPricingScenarioPricingtool.args = {};
