...
// Import Menu Item
import { PromoOptimizerPopupComponent } from './promo-optimizer-popup.component';

// Define component
export default {
    title: 'Organisms/PromoOptimizerPopup',
    component: PromoOptimizerPopupComponent,
...
// Define template
const PromoOptimizerPopupTemplate: Story<PromoOptimizerPopupComponent> = (args: PromoOptimizerPopupComponent) => ({
    props: { ...args },
    template: `<nwn-promo-optimizer-popup></nwn-promo-optimizer-popup>`,
});

export const PromoOptimizerPopup = PromoOptimizerPopupTemplate.bind({});
PromoOptimizerPopup.storyName = 'Promo Optimizer Popup';
PromoOptimizerPopup.args = {};
