...
// Import Menu Item
import { NumberPromoWavesComponent } from './number-promo-waves.component';

// Define component
export default {
    title: 'Organisms/NumberPromoWaves',
    component: NumberPromoWavesComponent,
...
// Define template
// NumberPromoWavesComponent template
const NumberPromoWavesTemplate: Story<NumberPromoWavesComponent> = (args: NumberPromoWavesComponent) => ({
    props: { ...args },
    template: `<nwn-number-promo-waves></nwn-number-promo-waves>`,
});

//
export const NumberPromoWaves = NumberPromoWavesTemplate.bind({});
NumberPromoWaves.storyName = 'Number Promo Waves';
NumberPromoWaves.args = {};
