...
// Define component
export default {
    title: 'Organisms/ManageMetricsComponent',
...
// Define template
// ManageMetricsComponent
const ManageMetricsComponentTemplate: Story<ManageMetricsComponent> = (args: ManageMetricsComponent) => ({
    props: { ...args },
    template: `<nwn-manage-metrics></nwn-manage-metrics>`,
});

export const ManageMetrics = ManageMetricsComponentTemplate.bind({});
ManageMetrics.storyName = 'Manage Metrics';
ManageMetrics.args = {};
