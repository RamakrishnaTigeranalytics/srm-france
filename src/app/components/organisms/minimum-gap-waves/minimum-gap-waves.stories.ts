...
// Import Menu Item
import { MinimumGapWavesComponent } from './minimum-gap-waves.component';

// Define component
export default {
    title: 'Organisms/MinimumGapWaves',
    component: MinimumGapWavesComponent,
...
// Define template
// MinimumGapWavesComponent template
const MinimumGapWavesTemplate: Story<MinimumGapWavesComponent> = (args: MinimumGapWavesComponent) => ({
    props: { ...args },
    template: `<nwn-minimum-gap-waves></nwn-minimum-gap-waves>`,
});

//
export const MinimumGapWaves = MinimumGapWavesTemplate.bind({});
MinimumGapWaves.storyName = 'Minimum Gap Waves';
MinimumGapWaves.args = {};
