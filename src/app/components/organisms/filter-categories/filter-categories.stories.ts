...
// Define component
export default {
    title: 'Organisms/FilterCategories',
...
// Define template
const FilterCategoriesTemplate: Story<FilterCategoriesComponent> = (args: FilterCategoriesComponent) => ({
    props: { ...args },
    template: `<nwn-filter-categories></nwn-filter-categories>`,
});

export const FilterCategories = FilterCategoriesTemplate.bind({});
FilterCategories.storyName = 'Filter categories';
