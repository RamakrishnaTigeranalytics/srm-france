...
// Import Menu Item
import { ComparePricingScenarioComponent } from './compare-pricing-scenario.component';

// Define component
export default {
    title: 'Organisms/ComparePricingScenarioComponent',
    component: ComparePricingScenarioComponent,
...
// Define template
// ComparePricingScenarioComponent
const ComparePricingScenarioComponentTemplate: Story<ComparePricingScenarioComponent> = (
    args: ComparePricingScenarioComponent,
) => ({
    props: { ...args },
    template: `<nwn-compare-pricing-scenario></nwn-compare-pricing-scenario>`,
});

export const ComparePricingScenario = ComparePricingScenarioComponentTemplate.bind({});
ComparePricingScenario.storyName = 'Compare Pricing Scenario';
ComparePricingScenario.args = {};
