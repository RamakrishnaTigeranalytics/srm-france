...
// Import Menu Item
import { PricingScenarioPricingtoolPopupComponent } from './pricing-scenario-pricingtool-popup.component';

// Define component
export default {
    title: 'Organisms/PricingScenarioPricingtoolPopupComponent',
    component: PricingScenarioPricingtoolPopupComponent,
...
// Define template
// PricingScenario
const PricingScenarioPricingtoolPopupComponentTemplate: Story<PricingScenarioPricingtoolPopupComponent> = (
    args: PricingScenarioPricingtoolPopupComponent,
) => ({
    props: { ...args },
    template: `<nwn-pricing-scenario-pricingtool-popup></nwn-pricing-scenario-pricingtool-popup>`,
});

export const PricingScenarioPricingtool = PricingScenarioPricingtoolPopupComponentTemplate.bind({});
PricingScenarioPricingtool.storyName = 'Pricing Scenario Pricingtool';
PricingScenarioPricingtool.args = {};
