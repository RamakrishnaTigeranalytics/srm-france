...
export class AddPromotionComponent implements OnInit {
    ...
    @Output()
    unitsPromoChange = new EventEmitter()
    ...
    _generate_form_promotion(){
        ...
        if(level_one == MUTLIBUY_KEY){
            ...
            if(joint_display && joint_display.length>0){
                ...
                // if( this.generated_promotion.includes("-")){
                //     var name = this.generated_promotion.split("-")[0];
                //     var abc =this.generated_promotion.split("-")[1];
                //     this.generated_promotion=name+"+" + joint_display+"-"+abc
                // }else{
            ...
            if(form_values['cp']){
                ...
                //     var name = this.generated_promotion.split("-")[0];
                //     var abc =this.generated_promotion.split("-")[1];
                //     this.generated_promotion=name+"+Leaflet"+"-"+abc
                // }else{
    ...
    applyPromotion(){
        ...
        if(this.input_promotions.length > 0){
            ...
            this.unitsPromoChange.emit(data);
