...
// Define component
export default {
    title: 'Organisms/AddPromotionComponent',
...
// Define template
// AddPromotionComponent
const AddPromotionComponentTemplate: Story<AddPromotionComponent> = (args: AddPromotionComponent) => ({
    props: { ...args },
    template: `<nwn-add-promotion></nwn-add-promotion>`,
});

export const AddPromotion = AddPromotionComponentTemplate.bind({});
AddPromotion.storyName = 'Add Promotion';
AddPromotion.args = {};
