...
// Define component
export default {
    title: 'Organisms/FilterBrands',
    component: FilterBrandsComponent,
...
// Define template
const FilterBrandsTemplate: Story<FilterBrandsComponent> = (args: FilterBrandsComponent) => ({
    props: { ...args },
    template: `<nwn-filter-brands></nwn-filter-brands>`,
});

export const FilterBrands = FilterBrandsTemplate.bind({});
FilterBrands.storyName = 'Filter brands';
FilterBrands.args = {};
