...
// Import Menu Item
import { AddCompareScenarioComponent } from './add-compare-scenario.component';

// Define component
export default {
    title: 'Organisms/AddCompareScenarioComponent',
    component: AddCompareScenarioComponent,
...
// Define template
// AddCompareScenarioComponent
const AddCompareScenarioComponentTemplate: Story<AddCompareScenarioComponent> = (
    args: AddCompareScenarioComponent,
) => ({
    props: { ...args },
    template: `<nwn-add-compare-scenario></nwn-add-compare-scenario>`,
});

export const AddCompareScenario = AddCompareScenarioComponentTemplate.bind({});
AddCompareScenario.storyName = 'Add Compare Scenario';
AddCompareScenario.args = {};
