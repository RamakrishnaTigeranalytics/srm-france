...
// Import Menu Item
import { FilterProductGroupsComponent } from './filter-product-groups.component';

// Define component
export default {
    title: 'Organisms/FilterProductGroups',
    component: FilterProductGroupsComponent,
...
// Define template
const FilterProductGroupsTemplate: Story<FilterProductGroupsComponent> = (args: FilterProductGroupsComponent) => ({
    props: { ...args },
    template: `<nwn-filter-product-groups></nwn-filter-product-groups>`,
});

export const FilterProductGroups = FilterProductGroupsTemplate.bind({});
FilterProductGroups.storyName = 'Filter brands formats';
FilterProductGroups.args = {};
