...
// Define component
export default {
    title: 'Organisms/PromotionDetailsComponent',
...
// Define template
// PromotionDetailsComponent
const PromotionDetailsComponentTemplate: Story<PromotionDetailsComponent> = (args: PromotionDetailsComponent) => ({
    props: { ...args },
    template: `<nwn-promotion-details></nwn-promotion-details>`,
});

export const PromotionDetails = PromotionDetailsComponentTemplate.bind({});
PromotionDetails.storyName = 'Promotion Details';
PromotionDetails.args = {};
